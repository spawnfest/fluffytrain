...
- **Exception Catcher**:
  - Implements gen_event handler to catch any exception raised by the application
- **Runtime Evaluator**:
  - Uses Elixir's **Code** package to evaluate code generated by LLM (Code.eval_string) or to apply a hot reload fix (Code.compile_string)
- **Text Extractor**:
